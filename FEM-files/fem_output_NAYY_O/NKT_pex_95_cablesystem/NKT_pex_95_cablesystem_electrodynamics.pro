...
Group{
  ...
  Con_1 = Region[ {100101103} ];// cable_1_core1_con_aluminum_corrected
  Con_2 = Region[ {100102103} ];// cable_1_core2_con_aluminum_corrected
  Con_3 = Region[ {100103103} ];// cable_1_core3_con_aluminum_corrected
  Con_4 = Region[ {100104103} ];// cable_1_core4_con_aluminum_corrected
  Conductors = Region[ {100101103,  100102103,  100103103,  100104103} ];
  ...
  DomainC += Region[ {100101103} ];// cable_1_core1_con_aluminum_corrected
  DomainC += Region[ {100102103} ];// cable_1_core2_con_aluminum_corrected
  DomainC += Region[ {100103103} ];// cable_1_core3_con_aluminum_corrected
  DomainC += Region[ {100104103} ];// cable_1_core4_con_aluminum_corrected
  DomainC += Region[ {200200102} ];// layer_2_earth_con_material_rho=100.0_epsr=1.0e-16_mu=1.0
  DomainC += Region[ {300200102} ];// infshell_2_earth_con_material_rho=100.0_epsr=1.0e-16_mu=1.0
  DomainCC += Region[ {100101204} ];// cable_1_core1_ins_pvc
  DomainCC += Region[ {100102204} ];// cable_1_core2_ins_pvc
  DomainCC += Region[ {100103204} ];// cable_1_core3_ins_pvc
  DomainCC += Region[ {100104204} ];// cable_1_core4_ins_pvc
...
Function{
  // Material properties for region 100101103: cable_1_core1_con_aluminum_corrected
  nu[Region[{100101103}]] = 795774.7154594767;
  sigma[Region[{100101103}]] = 3.391578033427393e7;
  epsilon[Region[{100101103}]] = 8.8541878128e-12;
  /*  Material properties for region 200200102:
  layer_2_earth_con_material_rho=100.0_epsr=1.0e-16_mu=1.0 */
  nu[Region[{200200102}]] = 795774.7154594767;
  sigma[Region[{200200102}]] = 0.01;
  epsilon[Region[{200200102}]] = 8.8541878128e-28;
  ...
  // Material properties for region 100103204: cable_1_core3_ins_pvc
  nu[Region[{100103204}]] = 795774.7154594767;
  sigma[Region[{100103204}]] = 1.0e-15;
  epsilon[Region[{100103204}]] = 7.08335025024e-11;
  // Material properties for region 100103103: cable_1_core3_con_aluminum_corrected
  nu[Region[{100103103}]] = 795774.7154594767;
  sigma[Region[{100103103}]] = 3.391578033427393e7;
  epsilon[Region[{100103103}]] = 8.8541878128e-12;
  // Material properties for region 100102103: cable_1_core2_con_aluminum_corrected
  nu[Region[{100102103}]] = 795774.7154594767;
  sigma[Region[{100102103}]] = 3.391578033427393e7;
  epsilon[Region[{100102103}]] = 8.8541878128e-12;
  // Material properties for region 100101204: cable_1_core1_ins_pvc
  nu[Region[{100101204}]] = 795774.7154594767;
  sigma[Region[{100101204}]] = 1.0e-15;
  epsilon[Region[{100101204}]] = 7.08335025024e-11;
  // Material properties for region 100102204: cable_1_core2_ins_pvc
  nu[Region[{100102204}]] = 795774.7154594767;
  sigma[Region[{100102204}]] = 1.0e-15;
  epsilon[Region[{100102204}]] = 7.08335025024e-11;
  // Material properties for region 100104204: cable_1_core4_ins_pvc
  nu[Region[{100104204}]] = 795774.7154594767;
  sigma[Region[{100104204}]] = 1.0e-15;
  epsilon[Region[{100104204}]] = 7.08335025024e-11;
  ...
  infshell_2_earth_con_material_rho=100.0_epsr=1.0e-16_mu=1.0 */
  nu[Region[{300200102}]] = 795774.7154594767;
  sigma[Region[{300200102}]] = 0.01;
  epsilon[Region[{300200102}]] = 8.8541878128e-28;
  // Material properties for region 100104103: cable_1_core4_con_aluminum_corrected
  nu[Region[{100104103}]] = 795774.7154594767;
  sigma[Region[{100104103}]] = 3.391578033427393e7;
  epsilon[Region[{100104103}]] = 8.8541878128e-12;
